...
[![Version](https://img.shields.io/badge/Version-1.0.0-orange.svg)](https://github.com/vellum-finance/vellum-agent-skill)
[![Platform](https://img.shields.io/badge/Platform-Base%20Blockchain-purple.svg)]()

**The Official Vellum Skill for AI Agents** — A powerful, secure, and easy-to-use toolkit that empowers AI agents to autonomously manage cryptocurrency operations on the Base blockchain.
...
Token Selling — Sell tokens back to ETH
Asset Transfer — Send ETH and USDC safely
